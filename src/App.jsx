...
const App = () => {
  const [movies, setMovies] = useState([
    ...
    {
      title: 'IBoy',
      description: 'Superhero sci-fi.',
      posterURL: 'https://upload.wikimedia.org/wikipedia/en/5/5e/IBoy_poster.jpg',
      rating: 4.8,
      trailerLink: 'https://www.youtube.com/embed/rlR4PJn8b8I',
    },
    {
      ...
      posterURL: 'https://upload.wikimedia.org/wikipedia/en/c/cb/Amar_%282017_film%29_poster.jpg',
      rating: 3.2,
      trailerLink: 'https://www.youtube.com/embed/rlR4PJn8b8I',
    },
    {
      title: 'Battle on Buka Street',
      description: 'A food thriller.',
      posterURL: 'https://upload.wikimedia.org/wikipedia/en/5/5d/Battle_on_Buka_Street_Poster.jpg',
      rating: 4.8,
      trailerLink: 'https://www.youtube.com/embed/rlR4PJn8b8I',
    },
    {
      title: 'After',
      description: ' American romantic-dramas .',
      posterURL: 'https://upload.wikimedia.org/wikipedia/en/thumb/2/23/After_film_series_logo.png/330px-After_film_series_logo.png',
      rating: 3.8,
    },
    {
      title: 'Spy',
      description: ' Action spy film.',
      posterURL: 'https://upload.wikimedia.org/wikipedia/en/9/9a/Spy_2023_film_poster.jpg',
      rating: 4.2,
    },
